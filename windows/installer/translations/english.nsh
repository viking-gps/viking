...
!insertmacro VIKING_MACRO_DEFAULT_STRING VIKING_FILE_ASSOCIATION_DESC	  "Associate .gpx, .fit, .kml and .tcx files with Viking"
!insertmacro VIKING_MACRO_DEFAULT_STRING VIKING_INSTALL_GPSBABEL_DESC	  "Viking recommends installing the GPSBabel program"
